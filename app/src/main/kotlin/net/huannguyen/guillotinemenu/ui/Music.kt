...
class MusicController : Controller() {
    ...
    override fun onAttach(view: View) {
        disposable = (view as MusicView).backClicks.subscribe { router.popCurrentController() }
    }
...
class MusicView(context: Context, attributeSet: AttributeSet) : LinearLayout(context, attributeSet), FeatureView {
    ...
    override fun onFinishInflate() {
        ...
        toolbar.setTitle(R.string.music_library_title)
